                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Privacy Policy<small>Policy for App Usage</small></h2>   
                                        <div class="col-md-4 pull-right">
                                            <a href="<?php echo base_url(); ?>play_store_privacy_policy" target='_blank' rel="noopener noreferrer" class='btn btn-primary'>Privacy Policy Page for Play Store</a>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2 col-sm-2 col-xs-12">Privacy Policy</label>
