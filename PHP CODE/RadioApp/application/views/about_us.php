                    ...
                    <div> 
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>About Us<small>About for App Usage</small></h2>   
                                        <div class="col-md-3 pull-right">
                                            <a href="<?php echo base_url(); ?>play_store_about_us" target='_blank' rel="noopener noreferrer" class='btn btn-primary'>About Us Page for App</a>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    ...
                                    <div class="x_content">
                                        <form method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2 col-sm-2 col-xs-12">About Us</label>
